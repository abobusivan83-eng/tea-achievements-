        ...
        <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <div className="mt-2 max-w-xl text-sm text-steam-muted md:text-base">
              Перевод монет между участниками клана. Списание у отправителя и зачисление получателю проходят в одной
              операции; повтор с тем же ключом идемпотентности не удвоит списание.
            </div>
          </div>
